            ...
            <div style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '15px' }}>
                    ...
                    <div style={{ backgroundColor: '#2a2a2a', padding: '20px', borderRadius: '10px', boxShadow: '0 2px 5px rgba(0,0,0,0.2)' }}>
                        ...
                        <input type="text" id="universityCollege" name="universityCollege" value={profileData.universityCollege} onChange={handleChange} style={{ width: '100%', padding: '8px', border: '1px solid #555', backgroundColor: '#333', borderRadius: '4px', color: '#e0e0e0', marginBottom: '10px' }} />

                        <label htmlFor="sports" style={{ display: 'block', marginBottom: '5px' }}>Sport(s):</label>
                        <select multiple id="sports" name="sports" value={profileData.sports} onChange={handleChange} style={{ width: '100%', padding: '8px', border: '1px solid #555', backgroundColor: '#333', borderRadius: '4px', color: '#e0e0e0', minHeight: '100px', marginBottom: '10px' }}>
                            {SPORTS_OPTIONS.map(option => (<option key={option} value={option}>{option}</option>))}
                        </select>
                        <small style={{ color: '#aaa', display: 'block', marginBottom: '10px' }}>Hold Ctrl (or Cmd on Mac) to select multiple sports.</small>
                        {profileData.sports && profileData.sports.includes('Other') && (
                            <div style={{ marginBottom: '10px' }}>
                                ...
                                <input type="text" id="sportsOther" name="sportsOther" value={profileData.sportsOther} onChange={handleChange} required style={{ width: '100%', padding: '8px', border: '1px solid #555', backgroundColor: '#333', borderRadius: '4px', color: '#e0e0e0' }} />
                            </div>
                        )}
                    </div>
